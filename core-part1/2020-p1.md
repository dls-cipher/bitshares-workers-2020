...
|:------------------------------- | :---------:|----------------------:|
| Manager                         |  $40/hour  | (closed)              |
| Senior Core Developer           |  $75/hour  | (closed)              |
| Junior Core Developer           |  $45/hour  | (open)                | 
| QA/Audit                        |  $75/hour  | (closed)              |
| Documentation Specialist        |  $30/hour  | (closed)              |
...
(USD maxcap = BTS rate from this worker * 0.05) 
...
- “Zavod Premik” will uphold this agreement with the BitShares Blockchain for 6 months(26 weeks), giving warranty on current structure / intent as CONSISTENT and fully transparent to the BTS Core token holders and BitShares Ecosystem.
